...
const { Types, Creators } = createActions({
    ...
    getCocktailsSuccess: ['payload'],
    getCocktailsFailure: ['payload'],
...
export const getCocktailsSuccess = (state, action) => {
    return state.merge({ fetching: false, error: false, errorMessage: '', cocktails: action.payload })
}

export const getCocktailsFailure = (state, action) => {
    return state.merge({ fetching: false, error: true, errorMessage: action.payload })
}
